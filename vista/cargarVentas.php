...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="row bg-title">
          ...
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
              <li><a href="#">Menú</a></li>
              <li class="active">Cargar Ventas</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="white-box">
              <div id="res"></div>
              <fieldset>
                <legend>Formulario Carga de Ventas</legend>
                <p>Para la carga masiva de ventas por favor llene el siguiente <a href="<?= FORMATO_CARGA_VENTAS ?>"><b>formato</b></a> con todas las ventas del mes.
                 Una vez este COMPLETAMENTE DILIGENCIADO guardelo en formato <b>CSV UTF-8(delimitado por comas)</b>, este archivo es el que debe ser cargado.<br><br><br>
                 <p class="blockquote-reverse">Los campos marcados con <span><em id="requerido">* </em></span> son requeridos.</p><br>
                 <form action="<?= CARGAR_VENTAS['url'] ?>" method="POST" enctype="multipart/form-data" id="form-cargar" class="form-horizontal col-lg-12 col-sm-12 col-md-12 col-xs-12" role="form">
                  <center>
                    <div class="form-group col-lg-12 col-sm-12 col-md-12 col-xs-12">
                      <label for="ven_archivo_ventas" class="col-lg-4 col-sm-3 col-md-4 col-xs-3 control-label">Seleccione un archivo: <span><em id="requerido" title="Campo Obligatorio">*</em></span></label>
                      <div class="col-lg-6 col-sm-12 col-md-7 col-xs-6">
                        <input class="form-control-file" type="file" name="ven_archivo_ventas" id="ven_archivo_ventas" accept=".csv" required/>
                      </div>
                    </div>
  ...
  $('#btnCargarDatos').on('click', function (e) {
    var form = $('#form-cargar'), archivo = $('#ven_archivo_ventas'), correo = $('#ven_correo');
    if (form.submit && archivo != null && correo != null) { 
